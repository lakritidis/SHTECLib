...
/// L2DV class Constructor: This calls the constructor of ClusteringAlgorithm<T,U> which in turn
/// calls the constructor of ClusteringMethod<T>
L2DV::L2DV(class Settings * p) :
	ClusteringAlgorithm<L2DVEntity, L2DVEntity>(p),
	tokens_index(NULL),
...
void L2DV::exec() {
	...
	this->cluster_universe = new ClusterUniverse<L2DVEntity >(num_slots);
...
/// The Hash Function
uint32_t L2DV::KazLibHash (char *key) {
