#include "L2DVEntity.h"

/// Default Constructor
L2DVEntity::L2DVEntity() : num_combinations(0), combinations(NULL), predicted_cluster(NULL) { }

/// Destructor
L2DVEntity::~L2DVEntity() {
...
uint32_t L2DVEntity::factorial(int32_t x) {
...
/// n! / (n-k)! calculation
uint32_t L2DVEntity::factorial_frac(uint32_t n, uint32_t k) {
	uint32_t frac = 1;
...
void L2DVEntity::construct_combinations(uint32_t K, class CombinationsLexicon * Lc, class Statistics * stats) {
...
void L2DVEntity::score_combinations(class Settings * sets, class Statistics * stats, class Token ** tindex) {
...
/// Accessors
inline Combination * L2DVEntity::get_predicted_cluster() { return this->predicted_cluster; }
